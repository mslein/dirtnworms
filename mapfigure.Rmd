...
study.area <- ggplot() +
  ...
  geom_sf_text(data = sites_sf_adj, aes(label = name), size = 3, nudge_y = 0.001) +
  annotation_scale(width_hint = 0.35, style = "bar") +
  annotation_north_arrow(location = "tr",
                         height = unit(0.9, "cm"), width = unit(0.6, "cm"),
                         which_north = "true") +
  coord_sf(xlim = c(-125.13, -125.15), ylim = c(48.82, 48.85)) + 
  theme_map()
study.area
```
...
bamfield.inlet + inset_element(inset,
                               left = -0.02, bottom = 0.4, right = 0.5, top = 1,
                               align_to = "panel") +
  study.area + plot_layout(ncol = 2)

ggsave("C:/Users/lterp/Desktop/OneDrive - UBC/dirtnworms/dirtnworms/figures/mapfigures/inlet-with-inset.PNG", width = 17, height = 17, units = "cm", background = "white", dpi = 800)
```
