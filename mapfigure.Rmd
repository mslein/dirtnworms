...
bamfield.inlet + inset_element(inset,
                               left = -0.03, bottom = 0.4, right = 0.5, top = 1,
                               align_to = "panel") +
  study.area + plot_layout(ncol = 2)

ggsave("C:/Users/lterp/Desktop/OneDrive - UBC/dirtnworms/dirtnworms/figures/mapfigures/inlet-with-inset.PNG", width = 20, height = 13, units = "cm", background = "white", dpi = 800)
```
